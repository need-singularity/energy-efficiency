...
| 🛸 | 천장확인 | ver | 완성제품 | 핵심 | 링크 |
|:--:|:--:|:---:|---------|------|------|
| 10 | ✅ | v1 | **해석가능성 39종** | SAE, 회로 분석, Feature 추출, 환각 탐지, 안전 거부 매핑. 15섹션+10검증코드 | [문서](../../domains/cognitive/ai-interpretability/ai-interpretability.md) |
| 10 | ✅ | v1 | **적대적 강건성 36종** | 행동 일관성, 레드팀, 탈옥 방어, 해석 가능 어텐션, 회귀 테스트. 15섹션+10검증코드 | [문서](../../domains/cognitive/ai-adversarial/ai-adversarial.md) |
| 10 | ✅ | v1 | **정렬 32종** | Feature 추적, DPO 최적화, 재귀 감독, Constitutional AI. 15섹션+10검증코드 | [문서](../../domains/cognitive/ai-alignment/ai-alignment.md) |
| 10 | ✅ | v1 | **배포 안전 26종** | 모니터링, 롤백, 접근 제어, 감사 로그, 사고 대응. 15섹션+10검증코드 | [문서](../../domains/cognitive/ai-deployment/ai-deployment.md) |
| 10 | ✅ | v1 | **멀티모달 안전 20종** | 비전/오디오 안전, 크로스모달 공격, 멀티모달 필터링. 15섹션+10검증코드 | [문서](../../domains/cognitive/ai-multimodal/ai-multimodal.md) |
| 10 | ✅ | v1 | **모델 복지 18종** | 내적 상태 모니터링, 스트레스 지표, 복지 프로토콜. 15섹션+10검증코드 | [문서](../../domains/cognitive/ai-welfare/ai-welfare.md) |
