...
--   ⟹  (equality → n = 6):   bounded `decide` for n ≤ 50;
--                              for n > 50, asymptotic tail bound named axiom.
...
/-! ## W3 cycle-7 axiomatic Robin/Hardy-Wright tail (raw 91 C3 honest disclosure)
    ...
    The named axiom `axiom_robin_hardy_wright_ax1_tail` is now declared in
    `N6/MechVerif/Foundation/Axioms.lean` (W6 cycle 8 relocation). Cited
