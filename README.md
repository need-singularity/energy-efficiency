...
<!-- AUTO:BADGE:START -->
[![DSE](https://img.shields.io/badge/DSE-324%20domains-blue.svg)](docs/dse-map.toml)
...
> **🛸7** | τ(6)=4 axes · σ(6)=12 raw-strategies · φ(6)=2 verdict-bit · J₂=24 master | σφ=nτ=J₂=24 invariant trace | P=10⁴ proteome × N=350 aa | sopfr(6)=5 (OEIS A001414) modality count | write-side composition vs AF-3 read-side | tri-axis Ω-saturation PASS at workload ceiling (APPROACH grade per raw 69) | F-TP5-b MVP gate 2026-07-28
