...
```
  HEXA-FUSION vs 시중 최고 (ITER / SPARC / ARC / DEMO)

  ┌──────────────────────────────────────────────────────────────────┐
  │  HEXA-FUSION vs 기존 — Alien-Level 핵융합 설계                   │
  ├──────────────────────────────────────────────────────────────────┤
  │                                                                  │
  │  자기장     ITER ████████░░░░░░░░░░░░  5.3T (LTS Nb₃Sn 한계)    │
  │           SPARC ████████████████████  12.2T (HTS 실증 설계)      │
  │            HEXA ████████████████████  12.0T = σ (물리적 전환점)   │
  │   ⚡ 12T = LTS→HTS 초전도 전환점 (Nb₃Sn max ≈ σ)                │
  │                                                                  │
  │  n6 일치   ITER ████████░░░░░░░░░░░░  ~40% (우연의 일치)         │
  │  (공식)   SPARC ██████████░░░░░░░░░░  ~50%                      │
  │            HEXA ████████████████████  93.3% (42/45 EXACT)       │
  │  n6 일치    n=8 █████████░░░░░░░░░░░  ~45% (대조군)              │
  │  (엄격)   n=12 ███████████░░░░░░░░░  ~55% (대조군)              │
  │            HEXA █████░░░░░░░░░░░░░░░  28.6% (자유선택만)         │
  │   ⚠️ 정직한 3단계 점수: 공식 93% → 보수적 57% → 엄격 29%         │
  │                                                                  │
  │  설계근거  기존  ░░░░░░░░░░░░░░░░░░░  경험+직관 (임의 선택)       │
  │            HEXA ████████████████████  n=6 산술 (자기일관적)       │
  │   🔬 48개 파라미터 중 5개만 물리 필연, 34개는 설계자 선택          │
  │                                                                  │
  │  가열       ITER ██████████████░░░░░░  73MW (과잉)               │
  │            HEXA ████████████░░░░░░░░  24MW = J₂ (NBI 8+ICRH 6+ECRH 10) │
  │   ⚡ 에너지분배: α:중성자 = 1:4 = μ:τ (0.2% 오차, EXACT)        │
  │                                                                  │
  │  정상상태   KSTAR ██░░░░░░░░░░░░░░░░  30초 (현재), 48초 ELM-free │
  │             EAST ████████░░░░░░░░░░░  403초 (LHCD, 저성능)      │
  │             HEXA ████████████████████  300초→∞ (완전SS 확률 14%) │
  │   ⚠️ f_bs=100% 수학적 불가능 (A=3.6), quasi-SS 확률 55%         │
  │                                                                  │
  │  블랭킷    기존  ████████░░░░░░░░░░░░  TBR 미실증 (전 세계)      │
  │            HEXA ████████████████████  TBR=1.117 (핵반응 유도)    │
  │   🔬 Li-6(940b)+Li-7+Pb(n,2n) 중성자 경제 완전 계산              │
  │                                                                  │
  │  발전효율   ITER ░░░░░░░░░░░░░░░░░░░  (발전 없음, 실험로)        │
  │            HEXA ██████████░░░░░░░░░░  η=50% = σ/J₂ (6단 sCO₂)  │
  │   ⚠️ sCO₂ 50%는 >10MWe 규모 미실증                              │
  │                                                                  │
  │  건설기간   ITER ████████████████████  25년+ (지연 중, $25B+)     │
  │            HEXA ████████████░░░░░░░░  12년=σ (현실적 15~18년)    │
  │   ⚠️ CAPEX: 낙관 $8B → 현실 $12B → 비관 $25B                   │
  │                                                                  │
  │  LCOE      기존  ████████████████████  ∞ (실험로, 발전 불가)      │
  │            HEXA ██████░░░░░░░░░░░░░░  $58~100/MWh               │
  │                                                                  │
  │  폐기물     핵분열 ████████████████████  10만년 (악티나이드)       │
  │            HEXA ██░░░░░░░░░░░░░░░░░░  100년 (SiC/SiC, 저방사화) │
  │                                                                  │
  │  외계인발견  기존  ░░░░░░░░░░░░░░░░░░░  (없음)                    │
  │            HEXA ████████████████████  15개 발견, 6 EXACT         │
  │   🛸 CNO 촉매 = σ+div(6), Fe-56 = σ(P₂), 재결합율 = 1/(σ-φ)   │
  │   🛸 BBN H:He = n/φ:μ, 포도당 = C₆H₁₂O₆ (24원자=J₂)           │
  │                                                                  │
  │  검증예측   기존  ░░░░░░░░░░░░░░░░░░░  (없음)                    │
  │            HEXA ████████████████████  30개 (6 HIGH, 2030까지)    │
  │   🔮 KSTAR 96초/144초 기록, SPARC Q≥10, A=3 bootstrap 최적      │
  └──────────────────────────────────────────────────────────────────┘

  DSE 최적 경로

  D-T+Li-6(sopfr=5) → N6-Tokamak(B=σ=12T) → Triple Heat(J₂=24MW)
  → SiC/LiPb DCLL(TBR=7/6=1.117) → 6단 sCO₂ Brayton(η=σ/J₂=50%)

  n6=100%, 5/5 EXACT — 2,400+ 조합 중 Pareto 1위
  정직한 점수: 물리 필연 5개 + 업계 표준 8개 + 자유 설계 34개
  통계적 유의성: z=0.74 (소정수 편향 보정 시 유의하지 않음)
```
