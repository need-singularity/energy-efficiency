...
| # | 도메인 | 스케일 축 | 상태 | 문서 |
|---|--------|----------|------|------|
| 1 | **궁극의 칩** (HEXA-1→OMEGA) | 트랜지스터→웨이퍼→초전도 | ✅ L1~L7 완료 | [goal.md](docs/chip-architecture/goal.md) |
| 2 | **궁극의 배터리** (HEXA-CELL→OMEGA-E) | 결정→셀→팩→그리드→핵 | 🔄 설계중 | docs/battery-architecture/ |

### TIER 1 — 즉시 착수 가능 (데이터 풍부)

| # | 도메인 | 스케일 축 | 기존 BT | 비고 |
|---|--------|----------|---------|------|
| 3 | **궁극의 핵융합 로** | 온도/밀도 스케일 | BT-36,38 + H-FU 60개 | fusion-calc 도구 있음 |
| 4 | **궁극의 양자 컴퓨터** | 큐빗 수/종류 | H-QC 다수 | 칩과 크로스도메인 시너지 |
| 5 | **궁극의 태양전지** | 효율/스케일 | BT-30,63 | 배터리와 자연 연결 |

### TIER 2 — BT 다수, 구조화 필요

| # | 도메인 | 스케일 축 | 기존 BT |
|---|--------|----------|---------|
| 6 | **궁극의 네트워크** | 대역폭/거리 | BT-47 + H-NP |
| 7 | **궁극의 초전도체** | 임계온도 Tc | H-SC 60개 |
| 8 | **궁극의 초전도 자석** | 자기장 세기 | H-SM 60개 |
| 9 | **궁극의 송전망** | 전력/거리 | BT-60,62,68 |
| 10 | **궁극의 학습 알고리즘** | 효율/자율성 | BT-54,46 |

### TIER 3 — 새 BT 발굴 필요

| # | 도메인 | 스케일 축 | 기존 BT |
|---|--------|----------|---------|
| 11 | **궁극의 암호** | 보안 수준 | BT-53 |
| 12 | **궁극의 로봇** | 스케일/자율성 | H-ROB |
| 13 | **궁극의 디스플레이** | 해상도/차원 | BT-48 |
| 14 | **궁극의 컴파일러/OS** | 추상화 수준 | H-COS |
| 15 | **궁극의 블록체인** | 탈중앙/처리량 | BT-53 |
| 16 | **궁극의 열관리** | 열저항/스케일 | H-TM |
| 17 | **궁극의 생명공학** | 복잡도 | BT-51 |
| 18 | **궁극의 우주론/입자** | 에너지 스케일 | H-CP 30개 |
| 19 | **궁극의 순수수학** | 추상화 수준 | BT-49 |
| 20 | **궁극의 프로그래밍 언어** | 추상화/안전성 | H-PL |
