...
```bash
hexa run /Users/ghost/core/canon/scripts/atlas_promote_7_to_10star.hexa
```
...
| Item | Path |
|------|------|
| This checklist | `/Users/ghost/core/canon/experiments/dse/atlas_promotion_manual_checklist_40.md` |
