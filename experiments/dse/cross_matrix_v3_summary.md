# DSE-P3-2 cross_matrix v3 요약 (112 × 10 × 77)

- 발행일: 2026-04-14
- 재현 seed: 42
- 전체 셀: 86,240 / 목표 86,240
- 커버리지: 100.0%
- 부모: experiments/dse/cross_matrix_112x10.json (P1 1,120 셀)
- 소스 정의: 7 기법 섹션 × 11 출처 카테 = 77 (P3 시점 고정)
...
## 출판
- full 텐서: experiments/dse/cross_matrix_v3_full.json (6.34 MB, 86,240 셀)
- 압축 사본: nexus/shared/dse/dse_cross_results_v3.json (16.2 KB)
- 요약: experiments/dse/cross_matrix_v3_summary.md (본 문서)

## 검증
- 셀 수 일치: 86240 == 86,240 -> PASS
- tech 수: 112 == 112 -> PASS
- domain 수: 10 == 10 -> PASS
- source 수: 77 == 77 -> PASS
- 커버리지: 100.0% == 100% -> PASS
