...
## 6. 시도 결과 — PASS / PARTIAL / MISS 세 시나리오

본 절은 DSE-P8-1 의 결과가 **미정** 인 상황에서, 향후 가능한 세 시나리오를 조건문
형태로 미리 작성해둔다. 최종 통합은 다음 cycle 로 이월.

### 6.1 시나리오 PASS — DSE-P8-1 이 L5 BARRIER 를 해소한 경우
...
### 6.2 시나리오 PARTIAL — DSE-P8-1 이 부분 진전을 이룬 경우
