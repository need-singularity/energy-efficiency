...
- `shared/n6/atlas.n6` L6_mechanical 7 nodes [10*] (cylinder-config, dof-rigid-body, gear-ratio-standard, bolt-grades, carnot-efficiency, hov-v95-dof)
- `shared/n6/atlas.n6` L6_civil 8 nodes
- `shared/n6/atlas.n6` L5_material 기계 서브셋
