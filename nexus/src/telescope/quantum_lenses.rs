...
pub fn quantum_topology_lens_entries() -> Vec<LensEntry> {
    vec![
        ...
        LensEntry { name: "cross_atlas_resonance".into(), category: LensCategory::Extended, description: "Detect resonating constant pairs across domain atlases (n6↔sedi↔anima)".into(), domain_affinity: vec!["meta".into(), "cross_domain".into(), "mathematics".into()], complementary: vec!["bt_auto_synthesizer".into(), "constant_relation_graph".into()] },
        // ══════════════════════════════════════════
