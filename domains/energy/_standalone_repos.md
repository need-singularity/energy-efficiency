...
| `room-temp-sc` ⊕ `superconductor` | 🧲 [need-singularity/hexa-rtsc](https://github.com/need-singularity/hexa-rtsc) | 2026-05-06 | Substrate-of-substrates: hexa-fusion(48T coil) · hexa-ufo(Meissner) · petite-cern(SC magnet) cross-link. RT-SC 학계 미증명 명시. MIT. |
