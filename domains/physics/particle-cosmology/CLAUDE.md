# particle-cosmology — CLAUDE 가이드

축: **physics**

## 파일
- `particle-cosmology.md` — 15섹션 통합 본문
...
- `verify_particle-cosmology_n6.hexa` → `/Users/ghost/Dev/nexus/shared/n6/scripts/verify_particle-cosmology_n6.hexa`
  - 실행: `hexa /Users/ghost/Dev/nexus/shared/n6/scripts/verify_particle-cosmology_n6.hexa`
