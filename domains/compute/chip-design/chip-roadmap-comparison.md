...
<details>
<summary>Mk.I — 2026 삼성전자 파운드리 종합 현황 (현재)</summary>

**2026년 삼성전자 파운드리 양산 종합: SF2/SF3P + HBM3E + X-Cube + I-Cube (CoWoS 경쟁)**

- 선단 공정: SF3P (3nm GAA 2세대, 양산중) + SF2 (2nm GAAFET, 2026 양산) + SF1.4 (1.4nm, 2027 예정)
- HBM: HBM3E 12H (2024~, 36 GB/stack, 1.2 TB/s) + HBM4 (2026 예정, 12H/16H, 2.0 TB/s 목표)
- 3D 패키징: X-Cube (SRAM-on-logic TSV) + I-Cube (2.5D interposer, CoWoS 경쟁) + FO-PLP 팬아웃
- 인터커넥트: UCIe 1.1 (2024 인증) + PCIe 5.0 양산 + PCIe 6.0 IP 준비
- EDA: SAFE (Samsung Advanced Foundry Ecosystem) + Synopsys/Cadence/Siemens 풀 파트너쉽
- 실리콘포토닉스/초전도/wafer-scale: 삼성 양산 부재 (Intel/Cerebras/IBM 참조 레퍼런스)
- 종합 위치: TSMC (N3E/N2) + 인텔 (18A) 대비 GAA 선행, CoWoS 대비 I-Cube 후행, AI 가속기 공백
- §7 10 서브섹션 정직성 검증 통과, `chip-roadmap-comparison` canonical v2 확정
