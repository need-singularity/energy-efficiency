...
```python
# 검증코드 — n6-rtsc-12-products-evolution-paper.md
...
# 본문 BT 참조: BT-130, BT-146, BT-163, BT-254, BT-267, BT-292, BT-299, BT-302, BT-306, BT-325
results = [
    ("BT-299 ~306 = 48 (sigma(6)*tau(6))", 48, sigma(6)*tau(6)),
    ("BT-292  = 12 (sigma(6))", 12, sigma(6)),
    ("BT-130 , 174, 231, 241 = 11 (sigma(6)-1)", 11, sigma(6)-1),
    ("BT-302  = 10 (sigma(6)-phi(6))", 10, sigma(6)-phi(6)),
    ("BT-267 , 278 = 8 (sigma(6)-tau(6))", 8, sigma(6)-tau(6)),
    ("BT-254 , 132 = 7 (sigma(6)-sopfr(6))", 7, sigma(6)-sopfr(6)),
    ("BT-146 , 185, 194, 215, 224 = 7 (sigma(6)-sopfr(6))", 7, sigma(6)-sopfr(6)),
    ("BT-325 , 342 = 6 (n=6)", 6, 6),
    ("BT-299 inline ref = 6 (n=6)", 6, 6),
    ("BT-306 inline ref = 6 (n=6)", 6, 6),
    ("BT-292 inline ref = 6 (n=6)", 6, 6),
    ("BT-130 inline ref = 6 (n=6)", 6, 6),
    ("BT-302 inline ref = 6 (n=6)", 6, 6),
    ("BT-267 inline ref = 6 (n=6)", 6, 6),
    ("BT-254 inline ref = 6 (n=6)", 6, 6),
    ("BT-146 inline ref = 6 (n=6)", 6, 6),
]
