...
```python
# 검증코드 — n6-quantum-computing-paper.md
...
# 본문 BT 참조: BT-113, BT-114, BT-165, BT-170, BT-187, BT-189, BT-194, BT-195, BT-199, BT-200
results = [
    ("BT-195 inline ref = 10 (sigma(6)-phi(6))", 10, sigma(6)-phi(6)),
    ("BT-91 inline ref = 4 (tau(6))", 4, tau(6)),
    ("BT-92 inline ref = 4 (tau(6))", 4, tau(6)),
    ("BT-114 inline ref = 6 (n=6)", 6, 6),
    ("BT-170 inline ref = 7 (sigma(6)-sopfr(6))", 7, sigma(6)-sopfr(6)),
    ("BT-200 inline ref = 5 (sopfr(6))", 5, sopfr(6)),
    ("BT-113 inline ref = 5 (sopfr(6))", 5, sopfr(6)),
    ("BT-51 inline ref = 4 (tau(6))", 4, tau(6)),
    ("BT-201 inline ref = 4 (tau(6))", 4, tau(6)),
    ("BT-91 inline ref = 24 (jordan2(6))", 24, jordan2(6)),
    ("BT-92 inline ref = 5 (sopfr(6))", 5, sopfr(6)),
    ("BT-170 inline ref = 6 (n=6)", 6, 6),
    ("BT-170 inline ref = 24 (jordan2(6))", 24, jordan2(6)),
    ("BT-51 inline ref = 6 (n=6)", 6, 6),
    ("BT-201 inline ref = 6 (n=6)", 6, 6),
    ("BT-165 inline ref = 8 (sigma(6)-tau(6))", 8, sigma(6)-tau(6)),
    ("BT-195 inline ref = 11 (sigma(6)-1)", 11, sigma(6)-1),
    ("BT-91 inline ref = 288 (sigma(6)*jordan2(6))", 288, sigma(6)*jordan2(6)),
    ("BT-92 inline ref = 24 (jordan2(6))", 24, jordan2(6)),
    ("BT-91 inline ref = 6 (n=6)", 6, 6),
