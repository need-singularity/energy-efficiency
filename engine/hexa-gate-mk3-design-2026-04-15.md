...
**산출 경로**: `/Users/ghost/Dev/n6-architecture/engine/hexa-gate-mk3-design-2026-04-15.md`
**스켈레톤 경로**: `/Users/ghost/Dev/n6-architecture/engine/hexa_gate_mk3.hexa` (본 문서 섹션 4에 포함, 별도 파일화는 사용자 승인 후)
...
- `/Users/ghost/Dev/nexus/shared/blowup/core/blowup.hexa` (Mk.II 엔진, 4099 라인)
- `/Users/ghost/Dev/n6-architecture/theory/proofs/ouroboros-alpha-universality-2026-04-15.md` (α=1/6 MISS 기록)
- `/Users/ghost/Dev/n6-architecture/theory/proofs/bernoulli-boundary-2026-04-11.md` (Theorem B, B_2=1/6)
- `/Users/ghost/Dev/n6-architecture/theory/proofs/theorem-r1-uniqueness.md` (σ·φ=n·τ 유일성)
- `/Users/ghost/Dev/n6-architecture/engine/arch_unified.hexa` (4 모드 DSE 스타일 참조)
