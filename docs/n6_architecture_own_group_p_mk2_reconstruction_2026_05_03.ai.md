---
schema: n6-architecture/docs/own_group_p_mk2_reconstruction/ai-native/1
...
# n6-architecture .own.group_p mk2 reconstruction — landed plan (2026-05-03)
...
- `n6shared/config/absolute_rules.json` (459 LoC) carries paper-md HARD rules at:
...
```
/Users/<user>/core/n6-architecture/.own.group_p
```

Parallel to (retired) mk1 `.own`. Schema: `n6-architecture/own/group_p/2`.
...
- path: `state/markers/n6_architecture_own_group_p_mk2_reconstruction.marker`
- format: JSON (schema `n6-architecture/markers/own_group_p_mk2_reconstruction/1`)
...
| `n6shared/config/absolute_rules.json` | durable SSOT (N62 / PP2 / R29 predate `.own`) |
