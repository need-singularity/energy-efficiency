...
```python
# 검증코드 — n6-pure-mathematics-paper.md
...
# 본문 BT 참조: (없음)
results = [
    ("n=6 (완전수) [본문 등장 170회]", 6, 6),
    ("phi(6)=2 (Euler totient) [본문 등장 152회]", 2, phi(6)),
    ("tau(6)=4 (약수개수) [본문 등장 47회]", 4, tau(6)),
    ("sigma(6)=12 (약수합) [본문 등장 42회]", 12, sigma(6)),
    ("J_2(6)=24 (Jordan totient) [본문 등장 38회]", 24, jordan2(6)),
    ("sopfr(6)=5 (소인수합) [본문 등장 25회]", 5, sopfr(6)),
    ("sigma-tau=8 [본문 등장 22회]", 8, sigma(6)-tau(6)),
    ("sigma-phi=10 [본문 등장 6회]", 10, sigma(6)-phi(6)),
]
