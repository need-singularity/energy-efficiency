...
```python
# 검증코드 — n6-energy-efficiency-paper.md
...
# 본문 BT 참조: (없음)
results = [
    ("phi(6)=2 (Euler totient) [본문 등장 142회]", 2, phi(6)),
    ("n=6 (완전수) [본문 등장 138회]", 6, 6),
    ("tau(6)=4 (약수개수) [본문 등장 69회]", 4, tau(6)),
    ("sopfr(6)=5 (소인수합) [본문 등장 32회]", 5, sopfr(6)),
    ("sigma-tau=8 [본문 등장 32회]", 8, sigma(6)-tau(6)),
    ("sigma(6)=12 (약수합) [본문 등장 31회]", 12, sigma(6)),
    ("sigma-phi=10 [본문 등장 11회]", 10, sigma(6)-phi(6)),
    ("J_2(6)=24 (Jordan totient) [본문 등장 11회]", 24, jordan2(6)),
]
