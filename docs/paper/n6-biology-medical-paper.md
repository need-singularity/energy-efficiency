...
```python
# 검증코드 — n6-biology-medical-paper.md
...
# 본문 BT 참조: BT-101, BT-103, BT-126, BT-132, BT-136, BT-141, BT-146, BT-188, BT-194, BT-254
results = [
    ("BT-51 inline ref = 14 (sigma(6)+phi(6))", 14, sigma(6)+phi(6)),
    ("BT-51 inline ref = 6 (n=6)", 6, 6),
    ("BT-141 inline ref = 4 (tau(6))", 4, tau(6)),
    ("BT-51 inline ref = 20 (jordan2(6)-tau(6))", 20, jordan2(6)-tau(6)),
    ("BT-101 inline ref = 5 (sopfr(6))", 5, sopfr(6)),
    ("BT-103 inline ref = 5 (sopfr(6))", 5, sopfr(6)),
    ("BT-132 inline ref = 6 (n=6)", 6, 6),
    ("BT-254 inline ref = 6 (n=6)", 6, 6),
    ("BT-284 inline ref = 4 (tau(6))", 4, tau(6)),
    ("BT-262 inline ref = 64 (2**n)", 64, 2**6),
    ("BT-126 inline ref = 7 (sigma(6)-sopfr(6))", 7, sigma(6)-sopfr(6)),
    ("BT-51 inline ref = 5 (sopfr(6))", 5, sopfr(6)),
    ("BT-283 inline ref = 6 (n=6)", 6, 6),
]
