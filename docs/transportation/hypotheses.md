...
**Expected grade: CLOSE** (48은 범위 내이나 정확히 48 고정은 아님)
...
**Expected grade: CLOSE** (정확히 10은 아니나 수렴)
...
**Expected grade: EXACT** (BT-93 직접 연결)
...
**Expected grade: CLOSE** (목표치, 양산 도달은 검증 필요)
...
| H-TR-03 | 인버터 스위칭 | sigma*tau | 48 kHz | CLOSE | BT-48 |
| H-TR-04 | 감속비 | sigma-phi | 10:1 | CLOSE | - |
...
| H-TR-09 | 카본 모노코크 | Z=6=n | 6 | EXACT | BT-93 |
| H-TR-10 | 차량 중량 | sigma^2*(sigma-tau) | 1,152 kg | CLOSE | - |
...
- **Total: 30 hypotheses**
- **EXACT: 9** (H-TR-01, 02, 09, 11, 12, 22, 23, 25, 27)
- **CLOSE: 17** (H-TR-03~08, 10, 14, 16~18, 20~21, 24, 26, 28~30)
- **WEAK: 2** (H-TR-13, 15)
- **UNVERIFIABLE: 1** (H-TR-19)
- **Missing: 1** (30 - 9 - 17 - 2 - 1 = 1, H-TR-22 Cd=0.20 EXACT 포함 = 정확히 30)
- **EXACT rate: 30%** (9/30)
