...
```
  ...
  신규 BT-1115: 키보드 레이아웃 n=6 보편성
  신규 BT-1116: USB HID n=6 프로토콜 수렴
  신규 BT-1117: 키보드 스위치 물리 n=6
```
...
## 카테고리 D: 인체공학 -- 타이핑의 신체 (BT-1117 확장)
