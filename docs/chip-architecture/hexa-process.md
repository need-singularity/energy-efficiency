...
- [ ] BSPDN (Backside Power Delivery) 파라미터 추가 (N2P+)
- [ ] 3D CFET stacking beyond 2-tier — n/φ = 3 tier 예측
- [ ] High-NA EUV 0.55 NA 양산 시점 파라미터 업데이트
- [ ] 450mm 웨이퍼 전환 시 n=6 매핑 (450 = σ·(σ·n/φ+R/φ)?)
- [ ] Verification script: experiments/verify_hexa_process.py
