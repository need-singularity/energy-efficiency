---
schema: n6-architecture/docs/own21_drift_policy/ai-native/1
...
1. **No producer for 1116 exists in this repo.** Searches across `tool/`, `scripts/`, `bin/`, `engine/`, `n6shared/`, `techniques/` find zero code that emits the integer 1116. This is a stale literal copied at TECS-L sync time on 2026-04-03 and never touched by an automated regen.
