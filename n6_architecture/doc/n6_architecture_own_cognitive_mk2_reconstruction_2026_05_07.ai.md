---
schema: n6-architecture/docs/own_cognitive_mk2_reconstruction/ai-native/1
...
ssot:
  ...
  sibling_handoffs:
    - n6_architecture/doc/n6_architecture_own_readme_mk2_reconstruction_2026_05_04.ai.md (.own.readme)
    - n6_architecture/doc/n6_architecture_own_group_p_mk2_reconstruction_2026_05_03.ai.md (.own.group_p)
...
related_docs:
  - n6_architecture/doc/n6_architecture_own_group_p_mk2_reconstruction_2026_05_03.ai.md (sibling — paper-md governance + .own.group_p own#6 collapsing precedent mirrored here)
  - n6_architecture/doc/n6_architecture_own_readme_mk2_reconstruction_2026_05_04.ai.md (sibling — README governance)
  - n6shared/config/absolute_rules.json (durable SSOT; predates `.own` reconstruction)
...
# n6-architecture .own.cognitive mk2 reconstruction — landed plan (2026-05-07)
...
- Schema: `project/own/v1` (hive-aligned); n6-architecture mk2 sibling files use `n6-architecture/own/<scope>/2` — divergence intentional per "hive mk2 기준" user directive turn 5
...
- This file: `n6_architecture/doc/n6_architecture_own_cognitive_mk2_reconstruction_2026_05_07.ai.md`
...
- Path: `state/markers/n6_architecture_own_cognitive_mk2_reconstruction.marker`
- Schema: `n6-architecture/markers/own_cognitive_mk2_reconstruction/1`
- Format: JSON (sibling-aligned with `n6_architecture_own_readme_mk2_reconstruction.marker` + `n6_architecture_own_group_p_mk2_reconstruction.marker`)
...
2. **Frontmatter divergence**: `.own.cognitive` 는 hive `.own` 형식 (`schema_version: project/own/v1` + `mk: 2`) 채택, sibling `.own.readme` / `.own.group_p` 의 n6-local 형식 (`schema: n6-architecture/own/<scope>/2` + ssot/policy nested keys) 와 다름. 사용자 directive turn 5 ("hive mk2 기준") 직접 결과. 향후 schema 정합성 follow-up 후보.
...
| `n6_architecture/doc/n6_architecture_own_cognitive_mk2_reconstruction_2026_05_07.ai.md` | this handoff | NEW |
| `state/markers/n6_architecture_own_cognitive_mk2_reconstruction.marker` | omega_cycle close marker | NEW |
| `.own.readme` | sibling mk2 SSOT (README scope) | unchanged |
| `.own.group_p` | sibling mk2 SSOT (paper-md scope) | unchanged |
| `n6shared/config/absolute_rules.json` | durable SSOT | unchanged |
...
4. **handoff** — this doc
5. **marker** — `state/markers/n6_architecture_own_cognitive_mk2_reconstruction.marker`
