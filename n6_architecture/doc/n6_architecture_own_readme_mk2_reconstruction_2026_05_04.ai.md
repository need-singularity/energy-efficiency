---
schema: n6-architecture/docs/own_readme_mk2_reconstruction/ai-native/1
...
# n6-architecture .own.readme mk2 reconstruction — landed plan (2026-05-04)
...
- README.md total LoC: **1370** (`/Users/<user>/core/n6-architecture/README.md`)
...
```
/Users/<user>/core/n6-architecture/.own.readme
```

Sibling to `.own.group_p` (paper-md, emitted 2026-05-03). Schema: `n6-architecture/own/readme/2`.
...
- path: `state/markers/n6_architecture_own_readme_mk2_reconstruction.marker`
- format: JSON (schema `n6-architecture/markers/own_readme_mk2_reconstruction/1`)
